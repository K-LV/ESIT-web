...
export default class InstallationContainer extends React.Component {
  ...
  getStepContent(stepIndex) {
    switch (stepIndex) {
      ...
      case 1:
        return <CameraComponent handleInstallationNext={this.props.handleInstallationNext} handleInstallationPrev={this.props.handleInstallationPrev} installation={this.props.installationObj} />
      case 2:
